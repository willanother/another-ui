...
function IphoneView({ children, className, style, ...props }: IphoneViewProps) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <path
          ...
          className="fill-[#333] dark:fill-[#cccc]"
        />
      </svg>
      <div
        style={{
          ...
          height: `${PHONE_HEIGHT}px`,
          padding: `
					${Math.ceil((PHONE_HEIGHT - SCREEN_HEIGHT) / 2)}px 
					${Math.ceil((PHONE_WIDTH - SCREEN_WIDTH) / 2)}px `
        }}
        className="relative z-1 [clip-path:url(#roundedCorners)] bg-black"
      >
        {children}
      </div>
    </div>
...
export { IphoneView, type IphoneViewProps };
